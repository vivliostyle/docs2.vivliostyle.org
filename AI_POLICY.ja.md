...
## 補足: コンテンツの品質と情報源への忠実性(本リポジトリ固有)

以下は本リポジトリ([docs2.vivliostyle.org](https://github.com/vivliostyle/docs2.vivliostyle.org))固有の補足である。
本リポジトリはドキュメントサイトであり、実際の執筆・翻訳作業を通じて積み重ねてきた、AI支援における実務上の注意点をここに記録する。
上記の開示の仕組み自体は、組織内の他プロジェクトと同じ形式に揃えている。
